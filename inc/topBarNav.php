            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="<?php echo base_url ?>?p=events">Progress Tracker</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url ?>?p=about">About</a></li>
                    </ul>
                    <div class="d-flex align-items-center">
                    </div>
                </div>
                <button class="btn btn-flat btn-primary" type="button" id="login">User Login</button>
                <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin/login.php?f=logout' ?>"><span class="fas fa-sign-out-alt"></span>Admin Login</a>
